...
export type Item = { id: string; assetId: string; x: number; y: number; w: number; h: number; rotation: number; mirrorX?: boolean; backSvg?: string; derivedFrom?: string; caption?: string; captionAlign?: 'left' | 'center'; captionFontSize?: number; rulerUnit?: 'mm' | 'cm' | 'in'; rulerWidth?: boolean; rulerHeight?: boolean; suppressRuler?: boolean }
